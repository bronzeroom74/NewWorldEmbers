...
########################################################
# Kszug's loc generator for focus files
#
# usage:
#   idea_loc_generator.py [-h] input_file output_file
#
# optional arguments:
#   -h
...
def read_input_file(input_path):
    ...
    for input_line in input_lines:
        if indent_level == 2 and " id " in input_line:
            split_line = input_line.split()
            ideas.append(split_line[2])
...
def read_output_file(output_path):
    ...
    for output_line in output_lines:
        if output_line != "l_english:" and output_line != "":
